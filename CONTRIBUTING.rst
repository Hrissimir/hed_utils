...
Welcome to ``hed_utils`` contributor's guide.
...
If you experience bugs or general issues with ``hed_utils``, please have a look
...
You can help improve ``hed_utils`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``hed_utils`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``hed_utils``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n hed_utils python=3 six virtualenv pytest pytest-cov
    conda activate hed_utils
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/hed_utils.git
    cd hed_utils
...
#. Install |pre-commit|_::
   ...
   ``hed_utils`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/hed_utils
.. _issue tracker: https://github.com/<USERNAME>/hed_utils/issues
.. <-- end -->
